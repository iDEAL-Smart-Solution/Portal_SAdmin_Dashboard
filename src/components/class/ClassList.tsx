...
const ClassList: React.FC<ClassListProps> = ({ onViewProfile, onEdit, onAddClass }) => {
  const { classList, isLoading, error, fetchClassList } = useClassStore();
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-red-50 border border-red-200 rounded-md p-4">
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-red-800">Error loading classes</h3>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                Manage classes and view student enrollment details
              </p>
            </div>
            <button
              onClick={onAddClass}
          ...
          <div className="text-center py-12">
            ...
            {!searchTerm && (
              <div className="mt-6">
                <button
                  onClick={onAddClass}
                  className="inline-flex items-center px-3 py-2 sm:px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200"
                >
                  <svg className="w-4 h-4 mr-1 sm:mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                  </svg>
